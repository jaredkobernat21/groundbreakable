...
export default async function CorridorDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <Link href="/dashboard/private/corridors" className="text-xs text-[#1c1c1c]/40 hover:text-[#1c1c1c]">
          ← All Corridors
        </Link>
      ...
      <section className={cardClass}>
        <div className="mb-3 text-xs uppercase tracking-wide text-[#1c1c1c]/40">Watchlist — Parcels &amp; Opportunities in Scope</div>
