...
import { gatherMarketBundles } from "@/lib/generatePersonalizedBrief";
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-[#1c1c1c]">Markets</h1>
        ...
        <Link href="/dashboard/markets/corridors" className="rounded-full border border-[#1c1c1c]/15 px-3 py-1.5 text-xs text-[#1c1c1c]/60 hover:border-[#1c1c1c]/30">
