...
import { SHIFT_CATEGORY_COLOR, SHIFT_CATEGORY_LABEL, SHIFT_IMPACT_COLOR, SHIFT_IMPACT_LABEL } from "@/lib/shiftConstants";
          ...
          >
            <div className="flex items-center gap-2 text-[11px] font-medium uppercase tracking-wide">
              <span
                ...
                style={{ backgroundColor: SHIFT_CATEGORY_COLOR[shift.category] }}
              />
